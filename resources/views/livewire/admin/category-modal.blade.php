        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            <label for="nama_kategori" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Nama Kategori:</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nama_kategori" placeholder="Masukkan Nama Kategori" wire:model="nama_kategori">
                            @error('nama_kategori') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="icon" class="block text-gray-700 dark:text-gray-200 text-sm font-bold mb-2">Icon (SVG Code):</label>
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="icon" wire:model="icon" placeholder="Masukkan Kode SVG Heroicons"></textarea>
